...
Route::prefix('referensi')->group(function () {
    ...
    Route::prefix('periode_manajemen')->group(function(){
        Route::get('index', 'App\Http\Controllers\Referensi\PeriodeManajemenController@index')->name('referensi.periode_manajemen.index');
        Route::post('create', 'App\Http\Controllers\Referensi\PeriodeManajemenController@create')->name('referensi.periode_manajemen.create');
        Route::post('edit', 'App\Http\Controllers\Referensi\PeriodeManajemenController@edit')->name('referensi.periode_manajemen.edit');
        Route::post('store', 'App\Http\Controllers\Referensi\PeriodeManajemenController@store')->name('referensi.periode_manajemen.store');
        Route::post('delete', 'App\Http\Controllers\Referensi\PeriodeManajemenController@delete')->name('referensi.periode_manajemen.delete');
        Route::get('datatable', 'App\Http\Controllers\Referensi\PeriodeManajemenController@datatable')->name('referensi.periode_manajemen.datatable');
    });
});
