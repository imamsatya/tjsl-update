...
<script>
    ...
    var datatable;
    var urlcreate = "{{route('userguide.create')}}";
    var urledit = "{{route('userguide.edit')}}";
    var urlstore = "{{route('userguide.store')}}";
    var urldatatable = "{{route('userguide.datatable')}}";
    var urldelete = "{{route('userguide.delete')}}";
