<form class="kt-form kt-form--label-right" method="POST" id="form-edit">
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-6">
            <label>Url</label>
            <input type="text" class="form-control" name="url" id="url" value="{{!empty(old('url'))? old('url') : ($actionform == 'update' && $data->url != ''? $data->url : old('url'))}}" required/>
        </div>
        <div class="col-lg-6">
