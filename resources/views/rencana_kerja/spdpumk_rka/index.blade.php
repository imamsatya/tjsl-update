...
@section('addafterjs')
    <script>
        ...
        var urlbatalfinalverifikasidata = "{{route('rencana_kerja.spdpumk_rka.batal_final_verifikasi_data')}}";
        ...
        $(document).ready(function() {
            ...
            var url = window.location.origin + '/rencana_kerja/spdpumk_rka/index';
