<form class="kt-form kt-form--label-right" method="POST" id="form-edit">
    ...
    <div class="mb-6 ">                                
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-9">
                <select id="tpb_id_edit" class="form-select form-select-solid form-select2" name="tpb_id_edit" data-kt-select2="true"  data-placeholder="Pilih TPB" data-allow-clear="true">
                    <option></option>
                    @foreach($tpb as $p)                                                
            ...
            <div class="col-lg-9 fv-row d-flex align-items-center justify-content-start">
                <div style="display:flex; flex-direction: row;">
                    <div class="form-check form-check-custom form-check-solid form-check-sm me-8">
                        <input {{ $data->kriteria_program_prioritas ? 'checked="checked"' : '' }} class="form-check-input" type="checkbox" name="kriteria_program_edit" value="prioritas" id="checkboxPrioritas_edit"/>
                        <label class="form-check-label" for="checkboxPrioritas_edit">
                            Prioritas
                        </label>
                    </div> 
                    <div class="form-check form-check-custom form-check-solid form-check-sm me-8">
                        <input {{ $data->kriteria_program_csv ? 'checked="checked"' : '' }} class="form-check-input" type="checkbox" name="kriteria_program_edit" value="csv" id="checkboxCSV_edit"/>
                        <label class="form-check-label" for="checkboxCSV_edit">
                            CSV
                        </label>
                    </div>
                    <div class="form-check form-check-custom form-check-solid form-check-sm">
                        <input {{ $data->kriteria_program_umum ? 'checked="checked"' : '' }} class="form-check-input" type="checkbox" name="kriteria_program_edit" value="umum" id="checkboxUmum_edit"/>
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-9">
                <select id="core_subject_id_edit" class="form-select form-select-solid form-select2" name="core_subject_id_edit" data-kt-select2="true" data-placeholder="Pilih ID Core Subject" data-allow-clear="true">
                    <option></option>
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-9">
                <select  id="pelaksanaan_program_edit" class="form-select form-select-solid form-select2" name="pelaksanaan_program_edit" data-kt-select2="true" data-placeholder="Pilih Pelaksanaan Program" data-allow-clear="true">
                    <option></option>
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-9">
                <select class="form-select form-select-solid form-select2" id="mitra_bumn_edit" name="mitra_bumn_edit" data-kt-select2="true" data-placeholder="Pilih Mitra BUMN" data-allow-clear="true" >
                    <option></option>
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-9 fv-row d-flex align-items-center justify-content-start">
                <div style="display:flex; flex-direction: row;">
                    <div class="form-check form-check-custom form-check-solid form-check-sm me-8">
                        <input {{ $data->multi_years ? 'checked="checked"' : '' }} class="form-check-input" type="radio" name="program_edit" id="multiyears_ya_edit" value="ya"/>
                        <label class="form-check-label" for="multiyears_ya_edit">
                            Ya
                        </label>
                    </div> 
                    <div class="form-check form-check-custom form-check-solid form-check-sm me-8">
                        <input {{ !$data->multi_years ? 'checked="checked"' : '' }} class="form-check-input" type="radio" name="program_edit" id="multiyears_tidak_edit" value="tidak"/>
