    ...
    <table class="table table-striped- table-bordered table-hover table-checkable" style="border: 1px solid black;display:none;" id="datatable_target">
        <thead>
            <tr>
                ...
                <th style="border: 1px solid black;font-weight:bold;">Tahun</th>
                <th style="border: 1px solid black;font-weight:bold;">Jan</th>
                <th style="border: 1px solid black;font-weight:bold;">Feb</th>
                <th style="border: 1px solid black;font-weight:bold;">Mar</th>
                <th style="border: 1px solid black;font-weight:bold;">Apr</th>
                <th style="border: 1px solid black;font-weight:bold;">Mei</th>
                <th style="border: 1px solid black;font-weight:bold;">Jun</th>
                <th style="border: 1px solid black;font-weight:bold;">Jul</th>
                <th style="border: 1px solid black;font-weight:bold;">Agus</th>
                <th style="border: 1px solid black;font-weight:bold;">Sep</th>
                <th style="border: 1px solid black;font-weight:bold;">Okt</th>
                <th style="border: 1px solid black;font-weight:bold;">Nov</th>
                <th style="border: 1px solid black;font-weight:bold;">Des</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td style="border: 1px solid black;text-align:right;">1</td>
                <td style="border: 1px solid black;text-align:right;">2021</td>
