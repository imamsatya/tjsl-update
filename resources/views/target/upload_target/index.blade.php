...
<script>
    ...
    var urlexportberhasil = "{{route('target.upload_target.export_berhasil')}}";
    var urlexportgagal = "{{route('target.upload_target.export_gagal')}}";
    ...
    function exportExcelBerhasil(id)
    {
        $.ajax({
            ...
            success: function(data){
                ...
                today = dd + '-' + mm + '-' + yyyy;
                var filename = 'Data Target TPB Berhasil Upload.xlsx';
    ...
    function exportExcelGagal(id)
    {
        $.ajax({
            ...
            success: function(data){
                ...
                today = dd + '-' + mm + '-' + yyyy;
                var filename = 'Data Target TPB Gagal Upload.xlsx';
