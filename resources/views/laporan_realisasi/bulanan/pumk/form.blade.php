<form class="kt-form kt-form--label-right" method="POST" id="form-edit">
    ...
    <div class="mb-6 ">
        <div class="row mb-6">
            ...
            <div class="col-lg-9">
                <input type="text" name="nama_program_edit" id="nama_program_edit" value="{{ $data->program }}"
                    class="form-control form-control-lg form-control-solid" placeholder="Nama Program" />
            </div>
        </div>
        <div class="row mb-6">
            <div class="col-lg-3">
            ...
            <div class="col-lg-9">
                <select id="tpb_id_edit" class="form-select form-select-solid form-select2" name="tpb_id_edit"
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-9">
                <div class="form-floating">
                    <textarea class="form-control" placeholder="Leave a comment here" id="unit_owner_edit" name="unit_owner_edit"
                        style="height: 100px">{{ $data->unit_owner }}</textarea>
            ...
            <div class="col-lg-9 fv-row d-flex align-items-center justify-content-start">
                <div style="display:flex; flex-direction: row;">
                    <div class="form-check form-check-custom form-check-solid form-check-sm me-8">
                        <input {{ $data->kriteria_program_prioritas ? 'checked="checked"' : '' }}
                            class="form-check-input" type="checkbox" name="kriteria_program_edit" value="prioritas"
                    ...
                    <div class="form-check form-check-custom form-check-solid form-check-sm me-8">
                        <input {{ $data->kriteria_program_csv ? 'checked="checked"' : '' }} class="form-check-input"
                    ...
                    <div class="form-check form-check-custom form-check-solid form-check-sm">
                        <input {{ $data->kriteria_program_umum ? 'checked="checked"' : '' }} class="form-check-input"
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-9">
                <select id="core_subject_id_edit" class="form-select form-select-solid form-select2"
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-9">
                <select id="pelaksanaan_program_edit" class="form-select form-select-solid form-select2"
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-9">
                <select class="form-select form-select-solid form-select2" id="mitra_bumn_edit"
                    name="mitra_bumn_edit" data-kt-select2="true" data-placeholder="Pilih Mitra BUMN"
                    data-allow-clear="true">
                    <option></option>
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-9 fv-row d-flex align-items-center justify-content-start">
                <div style="display:flex; flex-direction: row;">
                    <div class="form-check form-check-custom form-check-solid form-check-sm me-8">
                        <input {{ $data->multi_years ? 'checked="checked"' : '' }} class="form-check-input"
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-9">
                <input type="text" name="alokasi_anggaran_edit" id="alokasi_anggaran_edit"
