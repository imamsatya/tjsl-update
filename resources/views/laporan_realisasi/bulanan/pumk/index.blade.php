...
<script>
    ...
    var urlbatalfinalverifikasidata = "{{route('laporan_realisasi.bulanan.pumk.batal_final_verifikasi_data')}}";
    //
                ...
                },
                {
                    ...
                    orderable: false,
                        ...
                        render: function(data, type, row) {
                            ...
                            if (data === 4) {
                                 status = `<span class="btn cls-log badge badge-light-primary fw-bolder me-auto px-4 py-3" data-id="${row.id}">Validated</span>`
                            }
    ...
    function unverifySelectedData(selectedData) {
        ...
        swal.fire({
            title: "Pemberitahuan",
            html: "Yakin membatalkan verifikasi data ? <br/><span style='color: red; font-weight: bold'>[Data selected: "+jumlahSelected+" rows]</span>",
            icon: "warning",
            showCancelButton: true,
            confirmButtonText: "Ya",
            cancelButtonText: "Tidak"
    ...
    function finalVerifySelectedData(selectedData) {
        ...
        swal.fire({
            title: "Pemberitahuan",
            html: "Yakin validasi data ? <br/><span style='color: red; font-weight: bold'>[Data selected: "+jumlahSelected+" rows]</span>",
            icon: "warning",
            showCancelButton: true,
            confirmButtonText: "Ya",
            cancelButtonText: "Tidak"
    ...
    function finalUnverifySelectedData(selectedData) {
        ...
        swal.fire({
            title: "Pemberitahuan",
            html: "Yakin membatalkan validasi data ? <br/><span style='color: red; font-weight: bold'>[Data selected: "+jumlahSelected+" rows]</span>",
            icon: "warning",
            showCancelButton: true,
            confirmButtonText: "Ya",
            cancelButtonText: "Tidak"
