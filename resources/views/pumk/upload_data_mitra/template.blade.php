...
<html>
    ...
    <tr>
        <td colspan="29" style="background-color : #e3e3e3 ;width:5px; border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 2px solid #000000; border-right: 1px solid #000000" align="left" valign=middle ><b><font face="Arial" size=4 color="#000000"></font></b>{{$periode}}</td>
    </tr>
    <tr>
        <td colspan="12"></td>
    ...
    @if(!empty($data))
        ...
        <tr>
            ...
            <td>{{$val->tgl_awal?\PhpOffice\PhpSpreadsheet\Shared\Date::PHPToExcel($val->tgl_awal):"-"}}</td>
            <td>{{$val->tgl_jatuh_tempo?\PhpOffice\PhpSpreadsheet\Shared\Date::PHPToExcel($val->tgl_jatuh_tempo):"-"}}</td>
            ...
            <td>{{$val->tgl_penerimaan_terakhir?\PhpOffice\PhpSpreadsheet\Shared\Date::PHPToExcel($val->tgl_penerimaan_terakhir):"-"}}</td>
