...
<script>
    var datatable;
    var urlcreate = "{{route('referensi.jenis_pembayaran.create')}}";
    var urledit = "{{route('referensi.jenis_pembayaran.edit')}}";
    var urlstore = "{{route('referensi.jenis_pembayaran.store')}}";
    var urldatatable = "{{route('referensi.jenis_pembayaran.datatable')}}";
    var urldelete = "{{route('referensi.jenis_pembayaran.delete')}}";
