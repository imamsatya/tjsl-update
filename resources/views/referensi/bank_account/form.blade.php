<form class="kt-form kt-form--label-right" method="POST" id="form-edit">
    ...
    <div class="form-group row">
        <div class="col-lg-12">
            ...
            <input type="text" class="form-control" name="kode_bank" id="kode_bank" value="{{!empty(old('kode_bank'))? old('kode_bank') : ($actionform == 'update' && $data->kode_bank != ''? $data->kode_bank : old('kode_bank'))}}" required/>
        </div>
        <div class="col-lg-12">
