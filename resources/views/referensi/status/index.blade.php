...
<script>
    var datatable;
    var urlcreate = "{{route('referensi.status.create')}}";
    var urledit = "{{route('referensi.status.edit')}}";
    var urlstore = "{{route('referensi.status.store')}}";
    var urldatatable = "{{route('referensi.status.datatable')}}";
    var urldelete = "{{route('referensi.status.delete')}}";
