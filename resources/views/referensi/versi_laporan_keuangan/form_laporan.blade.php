<form class="kt-form kt-form--label-right" method="POST" id="form-edit">
    ...
    <div class="form-group row mb-5">
        ...
        <div class="col-lg-6">
            ...
            <select class="form-select form-select-solid form-select2" name="laporan_keuangan_id" data-kt-select2="true" data-placeholder="Pilih Pilar" data-dropdown-parent="#winform" data-allow-clear="true" required>
                <option></option>
