...
<script>
    var datatable;
    var urlcreate = "{{route('referensi.kondisi_pinjaman.create')}}";
    var urledit = "{{route('referensi.kondisi_pinjaman.edit')}}";
    var urlstore = "{{route('referensi.kondisi_pinjaman.store')}}";
    var urldatatable = "{{route('referensi.kondisi_pinjaman.datatable')}}";
    var urldelete = "{{route('referensi.kondisi_pinjaman.delete')}}";
