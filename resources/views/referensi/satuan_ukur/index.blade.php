...
@section('addafterjs')
    <script>
        var datatable;
        var urlcreate = "{{ route('referensi.satuan_ukur.create') }}";
        var urledit = "{{ route('referensi.satuan_ukur.edit') }}";
        var urlstore = "{{ route('referensi.satuan_ukur.store') }}";
        var urldatatable = "{{ route('referensi.satuan_ukur.datatable') }}";
        var urldelete = "{{ route('referensi.satuan_ukur.delete') }}";
