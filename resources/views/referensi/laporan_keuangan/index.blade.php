...
<script>
    var datatable;
    var urlcreate = "{{route('referensi.laporan_keuangan.create')}}";
    var urledit = "{{route('referensi.laporan_keuangan.edit')}}";
    var urlstore = "{{route('referensi.laporan_keuangan.store')}}";
    var urldatatable = "{{route('referensi.laporan_keuangan.datatable')}}";
    var urldelete = "{{route('referensi.laporan_keuangan.delete')}}";
