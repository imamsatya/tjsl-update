...
<script>
    var datatable;
    var urlcreate = "{{route('referensi.jenis_program.create')}}";
    var urledit = "{{route('referensi.jenis_program.edit')}}";
    var urlstore = "{{route('referensi.jenis_program.store')}}";
    var urldatatable = "{{route('referensi.jenis_program.datatable')}}";
    var urldelete = "{{route('referensi.jenis_program.delete')}}";
