...
<script>
    var datatable;
    var urlcreate = "{{route('referensi.api_whitelist.create')}}";
    var urledit = "{{route('referensi.api_whitelist.edit')}}";
    var urlstore = "{{route('referensi.api_whitelist.store')}}";
    var urldatatable = "{{route('referensi.api_whitelist.datatable')}}";
    var urldelete = "{{route('referensi.api_whitelist.delete')}}";
    var urlstatus = "{{route('referensi.api_whitelist.status')}}";
    ...
    $(document).ready(function(){
        ...
        $('body').on('click','#edit_active',function(){
            status(this);
        });
