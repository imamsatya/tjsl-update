<form class="kt-form kt-form--label-right" method="POST" id="form-edit">
    ...
    <div class="form-group row">
        <div class="col-lg-6">
            <label>IP User</label>
            <input type="text" class="form-control" name="ip_user" id="ip_user" value="{{!empty(old('ip_user'))? old('ip_user') : ($actionform == 'update' && $data->ip_user != ''? $data->ip_user : old('ip_user'))}}" required/>
        </div>
        <div class="col-lg-6">
...
<script type="text/javascript">
    ...
    function setFormValidate(){
        $('#form-edit').validate({
            ...
            messages: {
                ip_user: {
                    required: "IP User wajib diinput"
                }                                      		                   		                   
            },	        
