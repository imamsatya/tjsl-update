...
<script>
    var datatable;
    var urlcreate = "{{route('referensi.core_subject.create')}}";
    var urledit = "{{route('referensi.core_subject.edit')}}";
    var urlstore = "{{route('referensi.core_subject.store')}}";
    var urldatatable = "{{route('referensi.core_subject.datatable')}}";
    var urldelete = "{{route('referensi.core_subject.delete')}}";
