...
<script>
    var datatable;
    var urlcreate = "{{route('referensi.cara_penyaluran.create')}}";
    var urledit = "{{route('referensi.cara_penyaluran.edit')}}";
    var urlstore = "{{route('referensi.cara_penyaluran.store')}}";
    var urldatatable = "{{route('referensi.cara_penyaluran.datatable')}}";
    var urldelete = "{{route('referensi.cara_penyaluran.delete')}}";
