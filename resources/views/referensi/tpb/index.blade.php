                        ...
                        <form action="{{ route('referensi.tpb.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row mb-6">
                                        <!--begin::Label-->
                                        <label class="col-lg-4 col-form-label required fw-semibold fs-6">Kode TPB</label>
                                        <!--end::Label-->
                                        <!--begin::Col-->
                                        <div class="col-lg-8 fv-row">
                                            <input type="text" name="id_tpb"
                                                class="form-control form-control-lg form-control-solid"
                                                placeholder="Kode TPB" value="" />
                                    ...
                                    <div class="row mb-6">
                                        <!--begin::Label-->
                                        <label class="col-lg-4 col-form-label required fw-semibold fs-6">Nama TPB</label>
                                        <!--end::Label-->
                                        <!--begin::Col-->
                                        <div class="col-lg-8 fv-row">
                                            <input type="text" name="nama_tpb"
                                                class="form-control form-control-lg form-control-solid"
                                                placeholder="Nama TPB" value="" />
