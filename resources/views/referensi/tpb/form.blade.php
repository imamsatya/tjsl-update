    ...
    <div class="modal-body">
		...
		<div class="form-group row">
			<div class="col-lg-6">
                ...
                <select class="form-select form-select-solid form-select2" name="pilar_pembangunan_id" data-kt-select2="true" data-placeholder="Pilih Pilar" data-dropdown-parent="#form-edit" data-allow-clear="true">
                    <option></option>
					@foreach($pilar as $p)  
						@php
