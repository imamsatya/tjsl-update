...
<script>
    var datatable;
    var urlcreate = "{{route('referensi.owner_program.create')}}";
    var urledit = "{{route('referensi.owner_program.edit')}}";
    var urlstore = "{{route('referensi.owner_program.store')}}";
    var urldatatable = "{{route('referensi.owner_program.datatable')}}";
    var urldelete = "{{route('referensi.owner_program.delete')}}";
