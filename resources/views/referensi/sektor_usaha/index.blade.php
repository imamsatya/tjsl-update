...
<script>
    var datatable;
    var urlcreate = "{{route('referensi.sektor_usaha.create')}}";
    var urledit = "{{route('referensi.sektor_usaha.edit')}}";
    var urlstore = "{{route('referensi.sektor_usaha.store')}}";
    var urldatatable = "{{route('referensi.sektor_usaha.datatable')}}";
    var urldelete = "{{route('referensi.sektor_usaha.delete')}}";
