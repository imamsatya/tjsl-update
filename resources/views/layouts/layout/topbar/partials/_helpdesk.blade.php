											...
											<!--begin::Menu-->
											<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-700 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
												<!--begin::Menu item-->
												<div class="menu-item px-2">
														<li style="border-bottom:1px;">
															<a class="menu-link px-5">
																<strong style="color: blue; cursor:auto;">
																 Kontak Kami
																</strong>	
															</a>
														</li>
