...
class KolekbilitasPendanaanController extends Controller
{
    public function __construct()
    {
        $this->__route = 'referensi.kolekbilitas_pendanaan';
        $this->pagetitle = 'Kolekbilitas Pendanaan';
    }
    ...
    public function index()
    {
        return view($this->__route.'.index', [
            ...
            'breadcrumb' => 'Referensi - Kolekbilitas Pendanaan'
        ]);
    }
    ...
    {
        try{
            return datatables()->of(KolekbilitasPendanaan::query())
    ...
    {
        $kolekbilitaspendanaan = KolekbilitasPendanaan::get();

        return view($this->__route.'.form',[
            'pagetitle' => $this->pagetitle,
            'actionform' => 'insert',
            'data' => $kolekbilitaspendanaan
        ]);
        ...
        if (!$validator->fails()) {
            ...
            switch ($request->input('actionform')) {
                case 'insert': DB::beginTransaction();
                               try{
                                  $kolekbilitaspendanaan = KolekbilitasPendanaan::create((array)$param);
                ...
                case 'update': DB::beginTransaction();
                               try{
                                  $kolekbilitaspendanaan = KolekbilitasPendanaan::find((int)$request->input('id'));
                                  $kolekbilitaspendanaan->update((array)$param);
    ...
    public function delete(Request $request)
    {
        DB::beginTransaction();
        try{
            $data = KolekbilitasPendanaan::find((int)$request->input('id'));
            $data->delete();
