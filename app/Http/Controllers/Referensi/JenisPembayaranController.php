...
class JenisPembayaranController extends Controller
{
    ...
    {
        $this->__route = 'referensi.jenis_pembayaran';
        $this->pagetitle = 'Jenis Pembayaran';
    }
    ...
    public function index()
    {
        return view($this->__route.'.index', [
            ...
            'breadcrumb' => 'Referensi - Jenis Pembayaran'
        ]);
    }
    ...
    {
        try{
            return datatables()->of(JenisPembayaran::query())
        ...
        if (!$validator->fails()) {
            ...
            switch ($request->input('actionform')) {
                case 'insert': DB::beginTransaction();
                               try{
                                  $jenispembayaran = JenisPembayaran::create((array)$param);
                ...
                case 'update': DB::beginTransaction();
                               try{
                                  $jenispembayaran = JenisPembayaran::find((int)$request->input('id'));
                                  $jenispembayaran->update((array)$param);
    ...
    public function delete(Request $request)
    {
        DB::beginTransaction();
        try{
            $data = JenisPembayaran::find((int)$request->input('id'));
            $data->delete();
