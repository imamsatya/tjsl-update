...
class KodeTujuanTpbController extends Controller
{
    /**
    ...
    {
        $this->__route = 'referensi.kode_tujuan_tpb';
        $this->pagetitle = 'Kode Tujuan TPB';
    }
    ...
    public function index()
    {
        return view($this->__route.'.index',[
            ...
            'breadcrumb' => 'Referensi - Kode Tujuan TPB'
        ]);
    }
    ...
    {
        $kode = KodeTujuanTpb::orderBy('kode')->get();
        try{
    ...
    {
        $kode_indikator = KodeTujuanTpb::get();
    ...
    public function store(Request $request)
    {
        ...
        switch ($request->input('actionform')) {
            case 'insert': DB::beginTransaction();
                            try{
                                $kode_indikator = KodeTujuanTpb::create((array)$param);
            ...
            case 'update': DB::beginTransaction();
                            try{
                                $kode_indikator = KodeTujuanTpb::find((int)$request->input('id'));
    ...
    public function delete(Request $request)
    {
        DB::beginTransaction();
        try{
            $data = KodeTujuanTpb::find((int)$request->input('id'));
            $data->delete();
