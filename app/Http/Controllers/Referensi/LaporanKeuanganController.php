...
class LaporanKeuanganController extends Controller
{
    ...
    {
        $this->__route = 'referensi.laporan_keuangan';
    ...
    public function index()
    {
        return view($this->__route.'.index',[
            ...
            'breadcrumb' => 'Referensi - Laporan Keuangan'
        ]);
    }
    ...
    {
        try{
            return datatables()->of(LaporanKeuangan::query())
        ...
        if (!$validator->fails()) {
            ...
            switch ($request->input('actionform')) {
                case 'insert': DB::beginTransaction();
                               try{
                                  $laporankeuangan = LaporanKeuangan::create((array)$param);
                ...
                case 'update': DB::beginTransaction();
                               try{
                                  $laporankeuangan = LaporanKeuangan::find((int)$request->input('id'));
    ...
    public function delete(Request $request)
    {
        DB::beginTransaction();
        try{
            $data = LaporanKeuangan::find((int)$request->input('id'));
            $data->delete();
