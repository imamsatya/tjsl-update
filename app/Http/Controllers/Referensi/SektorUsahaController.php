...
class SektorUsahaController extends Controller
{
    ...
    {
        $this->__route = 'referensi.sektor_usaha';
        $this->pagetitle = 'Sektor Usaha Mitra Binaan';
    }
    ...
    public function index()
    {
        return view($this->__route.'.index', [
            ...
            'breadcrumb' => 'Referensi - Sektor Usaha Mitra Binaan'
        ]);
    }
    ...
    {
        try{
            return datatables()->of(SektorUsaha::query())
        ...
        if (!$validator->fails()) {
            ...
            switch ($request->input('actionform')) {
                case 'insert': DB::beginTransaction();
                               try{
                                  $sektorusaha = SektorUsaha::create((array)$param);
                ...
                case 'update': DB::beginTransaction();
                               try{
                                  $sektorusaha = SektorUsaha::find((int)$request->input('id'));
                                  $sektorusaha->update((array)$param);
    ...
    public function delete(Request $request)
    {
        DB::beginTransaction();
        try{
            $data = SektorUsaha::find((int)$request->input('id'));
            $data->delete();
