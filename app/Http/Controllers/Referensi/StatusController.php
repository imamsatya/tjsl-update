...
class StatusController extends Controller
{
    ...
    {
        $this->__route = 'referensi.status';
        $this->pagetitle = 'Status Pelaporan';
    }
        ...
        if (!$validator->fails()) {
            ...
            switch ($request->input('actionform')) {
                case 'insert': DB::beginTransaction();
                               try{
                                  $status = Status::create((array)$param);
                ...
                case 'update': DB::beginTransaction();
                               try{
                                  $status = Status::find((int)$request->input('id'));
    ...
    public function delete(Request $request)
    {
        DB::beginTransaction();
        try{
            $data = Status::find((int)$request->input('id'));
            $data->delete();
