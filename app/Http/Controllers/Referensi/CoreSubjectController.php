...
class CoreSubjectController extends Controller
{
    ...
    {
        $this->__route = 'referensi.core_subject';
        $this->pagetitle = 'Core Subject';
    }
    ...
    public function index()
    {
        return view($this->__route.'.index', [
            ...
            'breadcrumb' => 'Referensi - Core Subject'
        ]);
    }
    ...
    {
        try{
            return datatables()->of(CoreSubject::query())
        ...
        if (!$validator->fails()) {
            ...
            switch ($request->input('actionform')) {
                case 'insert': DB::beginTransaction();
                               try{
                                  $coresubject = CoreSubject::create((array)$param);
                ...
                case 'update': DB::beginTransaction();
                               try{
                                  $coresubject = CoreSubject::find((int)$request->input('id'));
                                  $coresubject->update((array)$param);
    ...
    public function delete(Request $request)
    {
        DB::beginTransaction();
        try{
            $data = CoreSubject::find((int)$request->input('id'));
            $data->delete();
